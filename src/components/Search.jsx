            ...
            <div className="w-full mt-6">
                <form onSubmit={handleSubmit} className="mx-auto w-full max-w-3xl">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 mt-4 sm:mt-6 overflow-x-auto py-2 scrollbar-hide">
                        <button
                            type="button"
                            onClick={() => goToTalents('/talents?sort=recent')}
                            className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-gray-700 bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:border-gray-300 transition-all duration-200 whitespace-nowrap flex-shrink-0"
                        >
                        ...
                        <button
                            type="button"
                            onClick={() => goToTalents('/talents?sort=popular')}
                            className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-gray-700 bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:border-gray-300 transition-all duration-200 whitespace-nowrap flex-shrink-0"
                        >
                        ...
                        <button
                            type="button"
                            onClick={() => goToTalents('/talents?maxPrice=250')}
                            className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-gray-700 bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:border-gray-300 transition-all duration-200 whitespace-nowrap flex-shrink-0"
                        >
                        ...
                        <button
                            type="button"
                            onClick={() => goToTalents('/talents/Fashion')}
                            className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-gray-700 bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:border-gray-300 transition-all duration-200 whitespace-nowrap flex-shrink-0"
                        >
                            <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
