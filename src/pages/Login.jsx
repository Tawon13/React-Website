            ...
            <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col lg:flex-row'>
                ...
                <div className='w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-12'>
                    <div className='w-full max-w-md'>
                        ...
                        {/* User Type Toggle */}
                        <div className='mb-8 flex gap-2 bg-gray-100 p-1 rounded-full'>
                            <button
                                type='button'
                                onClick={() => {
                        ...
                        <p className='text-gray-600 mb-8'>
                            {isSignUp ? (
                                <>
                                    {userType === 'influencer' ? 'Vous avez déjà un compte ?' : 'Déjà membre ?'}{' '}
                                    <button
                                        type='button'
                                ...
                                <>
                                    {userType === 'influencer' ? 'Vous n\'avez pas de compte ?' : 'Nouveau sur Collabzz ?'}{' '}
                                    <button
                                        type='button'
                                        onClick={() => setIsSignUp(true)}
                                        className='text-gray-900 font-semibold underline hover:text-primary transition-colors'
                                    >
                                        {userType === 'influencer' ? 'Créer un compte' : 'Créer un compte'}
                                    </button>
                                </>
                            )}
                        </p>
                        ...
                        <form onSubmit={handleSubmit} className='space-y-4'>
                            ...
                            <div>
                                <label className='block text-sm font-medium text-gray-700 mb-2'>
                                    {userType === 'brand' ? 'Email' : 'Adresse email'}
                                </label>
                                <input
                                    type='email'
                                    name='email'
                                    ...
                                    onChange={handleChange}
                                    className='w-full px-4 py-3 border border-gray-300 rounded-full focus:ring-2 focus:ring-gray-900 focus:border-transparent outline-none transition-all'
                                    placeholder={userType === 'brand' ? 'votre@email.com' : 'Adresse email'}
                                    required
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <div className='relative'>
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className='w-full px-4 py-3 border border-gray-300 rounded-full focus:ring-2 focus:ring-gray-900 focus:border-transparent outline-none transition-all'
                                        placeholder={userType === 'brand' ? '••••••••' : 'Mot de passe'}
                                        required
                                    />
                                    <button
                                        type='button'
                            ...
                            >
                                {loading ? 'Chargement...' : (isSignUp ? (userType === 'brand' ? 'Créer mon compte' : 'Créer un compte') : 'Se connecter')}
                            </button>
                            ...
                            {userType === 'influencer' ? (
                                <div className='grid grid-cols-2 gap-4'>
                                    <button
                                        ...
                                        disabled={loading}
                                        className='flex items-center justify-center gap-2 px-4 py-3 border border-gray-300 rounded-full hover:bg-gray-50 transition-all disabled:opacity-50'
                                    >
