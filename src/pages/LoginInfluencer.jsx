...
const LoginInfluencer = () => {
    ...
    const { signUpInfluencer, signIn, signInWithGoogle, signInWithFacebook } = useAuth()
    ...
    const handleGoogleSignIn = async () => {
        ...
        setLoading(true)
        try {
            await signInWithGoogle(true) // true = influencer
            navigate('/')
        } catch (error) {
    ...
    const handleFacebookSignIn = async () => {
        ...
        setLoading(true)
        try {
            await signInWithFacebook(true) // true = influencer
            navigate('/')
        } catch (error) {
